        ...
        <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:px-12 lg:py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          <div className="max-w-md">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Join thousands who've landed their dream jobs with AI-powered interview preparation.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-slate-200">Free tier to get started</span>
              </div>
              <div className="flex items-center">
                <div className="bg-violet-500/20 p-2 rounded-full mr-4 backdrop-blur">
                  <svg className="h-5 w-5 text-violet-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-slate-200">AI-powered interview coaching</span>
              </div>
              <div className="flex items-center">
                <div className="bg-violet-500/20 p-2 rounded-full mr-4 backdrop-blur">
                  <svg className="h-5 w-5 text-violet-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="mt-12 pt-8 border-t border-slate-700">
              <div className="space-y-3">
                <p className="text-sm text-slate-400">Transform your interview preparation:</p>
                <div className="bg-slate-800/50 p-4 rounded-lg backdrop-blur border border-slate-700">
                  <p className="text-sm text-slate-300">Start with our free tier and upgrade when you're ready for advanced AI features and unlimited applications.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-slate-900">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center">
              <h2 className="text-3xl font-bold text-white">Create your PrepAI account</h2>
              <p className="mt-2 text-slate-400">
                Start preparing for interviews like a pro
              </p>
            </div>
